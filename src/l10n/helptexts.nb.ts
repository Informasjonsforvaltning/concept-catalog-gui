...
Se mer om ‘kontaktinformasjon’ i [veileder for begrepsbeskrivelser](https://data.norge.no/specification/skos-ap-no-begrep#Begrep-kontaktpunkt)`,
  ...
  replacedByUnpublishedAbstract: "Referanse til upubliserte begrep i egen katalog som erstatter gjendelde begrep.",
  ...
  versionAbstract:
    "Versjonsnummer består av tall i tre ledd: major.minor.patch. Eks: 1.0.0",
